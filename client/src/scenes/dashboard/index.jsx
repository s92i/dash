...
import { DownloadOutlined, Email, PointOfSale, PersonAdd, Traffic, Download } from '@mui/icons-material'
        ...
        <Box m='1.5rem 2.5rem'>
            ...
            <Box mt='20px' display='grid' gridTemplateColumns='repeat(12, 1fr)' gridAutoRows='160px' gap='20px' sx={{
                ...
                <Box gridColumn='span 4' gridRow='span 3' backgroundColor={theme.palette.background.alt} p='1.5rem' borderRadius='0.55rem'>
                    ...
                    <Typography p='0 0.6rem' fontSize='0.8rem' sx={{ color: theme.palette.secondary[200] }}>Breakdown of real stats and information via category for revenue made for this year and total sales</Typography>
                </Box>
            </Box>
        </Box>
    )
